...
export const labels = {
  en: {
    ...
    trialBanner: "You have a 7-day free trial!",
    trialDescription: "Explore all features and manage your accessibility settings from the inculva dashboard.",
    openManage: "Open inculva Dashboard",
  ...
  tr: {
    ...
    trialBanner: "7 günlük ücretsiz deneme süreniz var!",
    trialDescription: "Tüm özellikleri keşfedin ve erişilebilirlik ayarlarınızı inculva panelinden yönetin.",
    openManage: "inculva Panelini Aç",
