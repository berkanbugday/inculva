...
export const tr: Translations = {
  ...
  footer: {
    ...
    wcagGuidelines: "WCAG Kılavuzu",
    adaCompliance: "ADA Uyumluluğu",
    about: "Hakkımızda",
    contact: "İletişim",
  ...
  contact: {
    ...
    liveChatHours: "Pazartesi-Cuma, 09:00-18:00 arası",
    documentationLabel: "Dokümantasyon",
    browseDocs: "Dokümanlarımıza göz atın →",
    avgResponseTime: "Ortalama yanıt süresi",
    under4Hours: "4 saatin altında",
    forBusinessHours: "İş saatleri sorgulamaları için",
  },
} as const;
