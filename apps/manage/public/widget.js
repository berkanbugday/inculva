var Ei=Object.defineProperty;var zi=(E,S,P)=>S in E?Ei(E,S,{enumerable:!0,configurable:!0,writable:!0,value:P}):E[S]=P;var w=(E,S,P)=>zi(E,typeof S!="symbol"?S+"":S,P);(function(){"use strict";const E="https://cdn.inculva.com/fonts",S=[];let P=!1;function Ie(){if(S.length>0)return Promise.resolve();if(P)return Promise.reject(new Error("Previous font load failed"));const e=[{url:`${E}/OpenDyslexic-Regular.woff2`,weight:"400"},{url:`${E}/OpenDyslexic-Bold.woff2`,weight:"700"}].map(({url:i,weight:t})=>new FontFace("OpenDyslexic",`url(${i})`,{weight:t,style:"normal",display:"swap"}).load().then(o=>{document.fonts.add(o),S.push(o)}).catch(o=>{throw console.error(`Failed to load dyslexia font from ${i}:`,o),P=!0,o}));return Promise.all(e).then(()=>{})}function Le(){for(const a of S)document.fonts.delete(a);S.length=0}function k(a,e){if(document.getElementById(a))return;const i=document.createElement("style");i.id=a,i.textContent=e,document.head.appendChild(i)}function F(a,e){let i=document.getElementById(a);i||(i=document.createElement("style"),i.id=a,document.head.appendChild(i)),i.textContent=e}function b(a){var e;(e=document.getElementById(a))==null||e.remove()}const Q={textResizing:4,lineHeight:4,textSpacing:4,contentMagnifier:4,saturation:5,colorBlindMode:4,textAlign:3,readingGuide:3,cursorEnhancement:3,slowCursor:3,screenReader:3},ae=["deuteranopia","protanopia","tritanopia","achromatopsia"],Y=new Map;function ne(){const a="inculva-html-filter",e=[...Y.values()];let i=document.getElementById(a);if(e.length===0){i==null||i.remove();return}i||(i=document.createElement("style"),i.id=a,document.head.appendChild(i)),i.textContent=`body { filter: ${e.join(" ")} !important; }`}function G(a,e){Y.set(a,e),ne()}function D(a){Y.delete(a),ne()}let V="deuteranopia";const Be={deuteranopia:"0.367 0.861 -0.228 0 0  0.280 0.673  0.047 0 0 -0.012 0.043  0.969 0 0  0 0 0 1 0",protanopia:"0.152 1.053 -0.205 0 0  0.115 0.786  0.099 0 0 -0.004 -0.048 1.052 0 0  0 0 0 1 0",tritanopia:"1.256 -0.077 -0.179 0 0 -0.078 0.931 0.148 0 0  0.005 0.691  0.304 0 0  0 0 0 1 0",achromatopsia:"0.299 0.587  0.114 0 0  0.299 0.587  0.114 0 0  0.299 0.587  0.114 0 0  0 0 0 1 0"};function oe(a){k("inculva-color-blind-filter-def","body::before { content: ''; position: fixed; width: 0; height: 0; }");let e=document.getElementById("inculva-color-blind-svg");e||(e=document.createElementNS("http://www.w3.org/2000/svg","svg"),e.id="inculva-color-blind-svg",e.setAttribute("style","position:absolute;width:0;height:0;overflow:hidden"),document.body.insertBefore(e,document.body.firstChild)),e.innerHTML=`<defs><filter id="inculva-cbf"><feColorMatrix type="matrix" values="${Be[a]}"/></filter></defs>`}function Re(){return V}function Ee(a){V=a,Y.has("colorBlind")&&oe(a)}function re(a){var i,t,n,o,r,l,s,c,d;let e=a;for(let u=0;u<4&&e&&e!==document.documentElement;u++){const m=e;if((i=m.id)!=null&&i.startsWith("inculva")||(n=(t=m.className)==null?void 0:t.includes)!=null&&n.call(t,"inculva"))return"";const p=e.getAttribute("aria-label");if(p!=null&&p.trim())return p.trim();const h=e.getAttribute("aria-labelledby");if(h){const C=(r=(o=document.getElementById(h))==null?void 0:o.textContent)==null?void 0:r.trim();if(C)return C}if(e instanceof HTMLImageElement)return((l=e.alt)==null?void 0:l.trim())||"Image with no description";if(e instanceof HTMLInputElement||e instanceof HTMLSelectElement||e instanceof HTMLTextAreaElement){const C=m.id,B=C?(c=(s=document.querySelector(`label[for="${C}"]`))==null?void 0:s.textContent)==null?void 0:c.trim():void 0;if(B)return B;if(e instanceof HTMLInputElement&&e.placeholder)return e.placeholder}const f=((d=m.innerText)!=null?d:"").trim();if(f.length>=2&&f.length<=500)return f;e=e.parentElement}return""}let L=null,W="";const q={en:"en-US",tr:"tr-TR",de:"de-DE",fr:"fr-FR",es:"es-ES",it:"it-IT",pt:"pt-BR",nl:"nl-NL",ar:"ar-SA",he:"he-IL",zh:"zh-CN",ja:"ja-JP",ko:"ko-KR",ru:"ru-RU",pl:"pl-PL",cs:"cs-CZ",da:"da-DK",fi:"fi-FI",el:"el-GR",hu:"hu-HU",ro:"ro-RO",sk:"sk-SK",sv:"sv-SE",uk:"uk-UA",bg:"bg-BG",hr:"hr-HR",lt:"lt-LT",lv:"lv-LV",et:"et-EE",sl:"sl-SI",sr:"sr-RS",no:"nb-NO",fa:"fa-IR",ur:"ur-PK",th:"th-TH",vi:"vi-VN",id:"id-ID",ms:"ms-MY",ca:"ca-ES",sq:"sq-AL",sw:"sw-TZ"};function _(a){W=a}function ze(a){var n,o;let e=a;for(;e&&e!==document.documentElement;){const r=e.getAttribute("lang");if(r)return(n=q[r.toLowerCase().slice(0,2)])!=null?n:r;e=e.parentElement}const t=document.documentElement.lang||W||"en";return(o=q[t.toLowerCase().slice(0,2)])!=null?o:t}function le(a,e){var t,n;if(!("speechSynthesis"in window)||!a.trim())return;window.speechSynthesis.cancel();const i=new SpeechSynthesisUtterance(a.trim().slice(0,350));i.rate=1.05,i.lang=e?ze(e):(n=(t=q[W])!=null?t:W)!=null?n:"en-US",window.speechSynthesis.speak(i)}function se(){var e,i;"speechSynthesis"in window&&window.speechSynthesis.cancel(),L!==null&&(clearTimeout(L),L=null);const a=window;(e=a.__inculvaSrCleanup)==null||e.call(a),delete a.__inculvaSrCleanup,b("inculva-screen-reader");for(const t of document.querySelectorAll("[data-inculva-tts-hover],[data-inculva-tts-tap]"))delete t.dataset.inculvaTtsHover,delete t.dataset.inculvaTtsTap;for(const t of document.querySelectorAll("[data-inculva-sr-wrap]")){const n=t.querySelector("img");n&&((i=t.parentNode)==null||i.insertBefore(n,t)),t.remove()}for(const t of document.querySelectorAll("[data-inculva-sr]"))t.classList.remove("inculva-no-alt"),delete t.dataset.inculvaSr}const ce=["","Alt hints","Read on hover","Read on tap"];let de=1.25;const O={textResizing:{enable:(a=1)=>{var i;F("inculva-text-resize",`html { font-size: ${(i=["110%","125%","140%","155%"][a-1])!=null?i:"110%"} !important; }`)},disable:()=>b("inculva-text-resize")},dyslexiaFont:{enable:()=>{Ie(),k("inculva-dyslexia-font","body * { font-family: 'OpenDyslexic', sans-serif !important; }")},disable:()=>{b("inculva-dyslexia-font"),Le()}},cursorEnhancement:{enable:(a=1)=>{var r;const e=[[32,6,3],[48,9,4],[64,12,6]],[i,t,n]=(r=e[Math.min(a,3)-1])!=null?r:e[0],o=`<svg xmlns="http://www.w3.org/2000/svg" width="${i}" height="${i}" viewBox="0 0 24 24"><path d="M5 2 L5 20 L9 16 L12 22.5 L15 21 L12 14.5 L18.5 14.5 Z" fill="white" stroke="black" stroke-width="1.8" stroke-linejoin="round" paint-order="stroke fill"/></svg>`;F("inculva-cursor",`body *:not([id^="inculva"]):not([class*="inculva"]) { cursor: url("data:image/svg+xml,${encodeURIComponent(o)}") ${t} ${n}, auto !important; }`)},disable:()=>b("inculva-cursor")},keyboardNavigation:{enable:()=>{k("inculva-keyboard-nav",`*:focus-visible:not([id^="inculva"]):not([class*="inculva"]) {
         ...
         }`)},disable:()=>{b("inculva-keyboard-nav")}},readingGuide:{enable:(a=1)=>{var c;const e=document.getElementById("inculva-reading-guide");e!=null&&e._moveHandler&&document.removeEventListener("mousemove",e._moveHandler),e==null||e.remove();const t=(c=["50vw","75vw","100vw"][a-1])!=null?c:"50vw",n=4,o=document.createElement("div");o.id="inculva-reading-guide",o.style.cssText=["position:fixed","left:50%","-webkit-transform:translateX(-50%)","transform:translateX(-50%)",`width:${t}`,`height:${n}px`,"background:var(--inculva-primary,#0066cc)","opacity:0.9","pointer-events:none","z-index:2147483642","top:0","border-radius:2px 2px 0 0"].join(";");const r=document.createElement("span");r.style.cssText=["position:absolute","bottom:100%","left:50%","-webkit-transform:translateX(-50%)","transform:translateX(-50%)","width:0","height:0","border-left:10px solid transparent","border-right:10px solid transparent","border-bottom:11px solid var(--inculva-primary,#0066cc)","display:block","opacity:0.9"].join(";"),o.appendChild(r),document.documentElement.appendChild(o);const l=t==="100vw",s=d=>{o.style.top=`${d.clientY}px`,l||(o.style.left=`${d.clientX}px`)};o._moveHandler=s,document.addEventListener("mousemove",s)},disable:()=>{const a=document.getElementById("inculva-reading-guide");a!=null&&a._moveHandler&&document.removeEventListener("mousemove",a._moveHandler),a==null||a.remove()}},screenReader:{enable:(a=1)=>{if(se(),a===1){let e=function(t){if(t.dataset.inculvaSr||t.closest("#inculva-widget-panel,#inculva-widget-btn"))return;t.dataset.inculvaSr="1";const n=t.getAttribute("alt");if(!(n!==null&&n.trim()!=="")){t.classList.add("inculva-no-alt");return}const r=t.parentNode;if(!r)return;const l=document.createElement("span");l.className="inculva-alt-wrap",l.setAttribute("data-inculva-sr-wrap","1"),r.insertBefore(l,t),l.appendChild(t);const s=document.createElement("span");s.className="inculva-alt-badge",s.textContent=n,l.appendChild(s)};k("inculva-screen-reader",`img.inculva-no-alt { outline: 3px solid #dc2626 !important; outline-offset: 3px !important; }
           ...
           }`);for(const t of document.querySelectorAll("img"))e(t);const i=new MutationObserver(t=>{for(const n of t)if(!(n.target instanceof Element&&n.target.closest("#inculva-widget-panel,#inculva-widget-btn"))){for(const o of n.addedNodes)if(o instanceof HTMLImageElement)e(o);else if(o instanceof HTMLElement)for(const r of o.querySelectorAll("img"))e(r)}});i.observe(document.body,{childList:!0,subtree:!0}),window.__inculvaSrCleanup=()=>i.disconnect()}else if(a===2){k("inculva-screen-reader",`[data-inculva-tts-hover] {
             outline: 2px dashed var(--inculva-primary, #0066cc) !important;
             outline-offset: 3px !important;
           }`);let e=null;const i=n=>{const o=n.target;if(!(!o||o===e)&&!o.closest("#inculva-widget-panel,#inculva-widget-btn")){e=o,L!==null&&(clearTimeout(L),L=null);for(const r of document.querySelectorAll("[data-inculva-tts-hover]"))delete r.dataset.inculvaTtsHover;L=setTimeout(()=>{const r=re(o);r&&(o.dataset.inculvaTtsHover="1",le(r,o))},400)}},t=()=>{L!==null&&(clearTimeout(L),L=null)};document.addEventListener("mouseover",i),document.addEventListener("mouseout",t),window.__inculvaSrCleanup=()=>{document.removeEventListener("mouseover",i),document.removeEventListener("mouseout",t)}}else{k("inculva-screen-reader",`[data-inculva-tts-tap] {
             outline: 2px solid var(--inculva-primary, #0066cc) !important;
             outline-offset: 3px !important;
           }`);let e=null;const i=t=>{const n=t.target;if(!n||n.closest("#inculva-widget-panel,#inculva-widget-btn"))return;e&&delete e.dataset.inculvaTtsTap;const o=re(n);o&&(e=n,n.dataset.inculvaTtsTap="1",le(o,n),setTimeout(()=>{e===n&&(delete n.dataset.inculvaTtsTap,e=null)},2500))};document.addEventListener("click",i),window.__inculvaSrCleanup=()=>{document.removeEventListener("click",i)}}},disable:()=>se()},pauseAnimations:{enable:()=>k("inculva-pause-animations","body *, body *::before, body *::after { animation-play-state: paused !important; transition: none !important; }"),disable:()=>b("inculva-pause-animations")},textSpacing:{enable:(a=1)=>{var o;const e=[{lh:"1.5",ls:"0.06em",ws:"0.10em"},{lh:"1.7",ls:"0.12em",ws:"0.16em"},{lh:"1.9",ls:"0.16em",ws:"0.20em"},{lh:"2.1",ls:"0.20em",ws:"0.24em"}],{lh:i,ls:t,ws:n}=(o=e[a-1])!=null?o:e[0];F("inculva-text-spacing",`body * { line-height: ${i} !important; letter-spacing: ${t} !important; word-spacing: ${n} !important; }
         body p { margin-bottom: 2em !important; }`)},disable:()=>b("inculva-text-spacing")},highlightLinks:{enable:()=>k("inculva-highlight-links","body a, body a:visited { text-decoration: underline !important; font-weight: bold !important; outline: 2px solid currentColor !important; outline-offset: 1px !important; }"),disable:()=>b("inculva-highlight-links")},colorBlindMode:{enable:(a=1)=>{var i;const e=(i=ae[a-1])!=null?i:"deuteranopia";V=e,oe(e),G("colorBlind","url(#inculva-cbf)")},disable:()=>{var a;D("colorBlind"),b("inculva-color-blind-filter-def"),(a=document.getElementById("inculva-color-blind-svg"))==null||a.remove(),V="deuteranopia"}},largeClickTargets:{enable:()=>k("inculva-large-targets",`a, button, input, select, textarea, [role="button"], [role="link"], [role="checkbox"], [role="radio"], [tabindex] {
...
`,Ae="inculva-widget-prefs";function Li(a){try{localStorage.setItem(Ae,JSON.stringify(a))}catch(e){}}function Bi(){try{const a=localStorage.getItem(Ae);return a?JSON.parse(a):{}}catch(a){return{}}}const xe="inculva-session-id";let te=null;function Ri(){try{let a=sessionStorage.getItem(xe);return a||(a=crypto.randomUUID(),sessionStorage.setItem(xe,a)),a}catch(a){return te||(te=crypto.randomUUID()),te}}const we={position:"bottom-right",theme:"light",primaryColor:"#0066cc",language:"en",features:{textResizing:!0,dyslexiaFont:!0,cursorEnhancement:!0,keyboardNavigation:!0,readingGuide:!0,screenReader:!0,pauseAnimations:!0,textSpacing:!0,highlightLinks:!0,colorBlindMode:!0,largeClickTargets:!0,focusHighlight:!0,skipNavigation:!0,muteMedia:!0,readingMask:!0,textAlign:!0,saturation:!0,blueLightFilter:!0,hideImages:!0,darkMode:!0,contentMagnifier:!0,toolTips:!1,sustainabilityMode:!1,slowCursor:!0,dictionary:!1,lineHeight:!0,highlightTitles:!0}};class Ce{constructor(e){w(this,"config");w(this,"activeFeatures",new Set);w(this,"activeProfiles",new Set);w(this,"featureLevels",new Map);w(this,"_restoring",!1);w(this,"isOpen",!1);w(this,"btn");w(this,"badge");w(this,"panel");w(this,"backdrop");w(this,"liveRegion");w(this,"tooltip");w(this,"apiBase");w(this,"labels",{});var i;this.config={...we,...e,features:{...we.features,...e.features}},this.apiBase=(i=window.INCULVA_API_URL)!=null?i:"https://api.inculva.com",this.init()}get _labels(){return{...ee(this.config.language),...this.labels}}init(){this.bootstrap()}async bootstrap(){await this.fetchRemoteConfig()&&(this.injectStyles(),this.applyTheme(),this.renderWidget(),_(this.config.language),this.applyConfigToDOM(),this.restorePrefs())}injectStyles(){const e=document.createElement("style");e.id="inculva-styles",e.textContent=Ii.replace(/var\(--inculva-primary,\s*#0066cc\)/g,`var(--inculva-primary, ${this.config.primaryColor})`),document.head.appendChild(e),document.documentElement.style.setProperty("--inculva-primary",this.config.primaryColor);const i=this.config.primaryColor.replace("#",""),t=parseInt(i.slice(0,2),16),n=parseInt(i.slice(2,4),16),o=parseInt(i.slice(4,6),16);document.documentElement.style.setProperty("--inculva-primary-rgb",`${t},${n},${o}`)}applyTheme(){const e=this.config.theme==="auto"?window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light":this.config.theme;document.documentElement.setAttribute("data-inculva-theme",e)}renderWidget(){this.btn=Si(this.config.primaryColor),this.badge=this.btn.querySelector("#inculva-widget-badge"),this.panel=Mi(this.config.features,this.config.language,this.config.accessibilityStatementUrl,this.config.whiteLabelText,this.config.position.includes("left")),this.backdrop=document.createElement("div"),this.backdrop.id="inculva-widget-backdrop",this.backdrop.addEventListener("click",()=>this.closePanel()),this.liveRegion=document.createElement("div"),this.liveRegion.setAttribute("role","status"),this.liveRegion.setAttribute("aria-live","polite"),this.liveRegion.setAttribute("aria-atomic","true"),this.liveRegion.className="inculva-sr-only",document.body.appendChild(this.liveRegion),H(this.btn,this.config.position),H(this.panel,this.config.position),this.config.position.includes("left")&&this.panel.setAttribute("data-panel-side","left"),this.btn.addEventListener("click",()=>this.togglePanel()),this.panel.addEventListener("click",e=>{const i=e.target.closest("[data-inculva-action]");if(i){const s=i.dataset.inculvaAction;if(s==="close"){this.closePanel();return}if(s==="reset"){this.resetAll();return}if(s==="toggle-profiles"){this.toggleProfiles();return}if(s==="switch-side"){this.switchSide();return}if(s==="lang-dropdown-toggle"){this._toggleLangDropdown();return}if(s==="set-language"){const c=i.dataset.langCode;c&&this._setLanguage(c);return}}const t=e.target.closest(".inculva-ctrl-btn.inculva-size-btn, .inculva-mini-btn");if(t!=null&&t.dataset.size){this.switchSize(t.dataset.size);return}const n=e.target.closest("[data-inculva-tab]");if(n!=null&&n.dataset.inculvaTab){this.switchTab(n.dataset.inculvaTab);return}const o=e.target.closest("[data-profile]");if(o!=null&&o.dataset.profile){this.activateProfile(o.dataset.profile);return}const r=e.target.closest("[data-cbm-type]");if(r!=null&&r.dataset.cbmType){this.selectColorBlindType(r.dataset.cbmType);return}const l=e.target.closest("[data-feature]");if(l!=null&&l.dataset.feature){const s=l.dataset.feature;Q[s]?this.cycleFeatureLevel(s):this.toggleFeature(s)}}),document.addEventListener("keydown",e=>{var i;if(e.altKey&&!e.shiftKey&&!e.ctrlKey&&!e.metaKey&&e.key==="a"){e.preventDefault(),this.togglePanel();return}if(e.key==="Escape"&&this.isOpen){const t=this.panel.querySelector(".inculva-lang-dropdown");if(t!=null&&t.classList.contains("open")){this._closeLangDropdown();return}this.closePanel();return}if(this.isOpen&&(e.key==="ArrowDown"||e.key==="ArrowUp")){const t=this.panel.querySelector(".inculva-lang-dropdown");if(t!=null&&t.classList.contains("open")){e.preventDefault();const n=Array.from(t.querySelectorAll(".inculva-lang-option")),o=document.activeElement,r=n.indexOf(o),l=e.key==="ArrowDown"?Math.min(r+1,n.length-1):Math.max(r-1,0);(i=n[l])==null||i.focus();return}}e.key==="Tab"&&this.isOpen&&this.trapFocus(e)}),this.tooltip=document.createElement("div"),this.tooltip.id="inculva-tooltip",document.documentElement.appendChild(this.tooltip),this.panel.addEventListener("input",e=>{var o,r,l,s,c;const i=e.target;if(!i.classList.contains("inculva-lang-search"))return;const t=i.value.toLowerCase().trim(),n=this.panel.querySelector(".inculva-lang-dropdown");if(n)for(const d of n.querySelectorAll(".inculva-lang-option")){if(!t){d.classList.remove("inculva-hidden");continue}const u=(l=(r=(o=d.querySelector(".inculva-lang-name"))==null?void 0:o.textContent)==null?void 0:r.toLowerCase())!=null?l:"",m=((s=d.dataset.enName)!=null?s:"").toLowerCase(),p=((c=d.dataset.langCode)!=null?c:"").toLowerCase(),h=u.includes(t)||m.includes(t)||p.startsWith(t);d.classList.toggle("inculva-hidden",!h)}}),this.panel.addEventListener("mouseover",e=>{const i=e.target.closest("[data-tooltip]");i&&this._showTooltip(i)}),this.panel.addEventListener("mouseout",e=>{e.target.closest("[data-tooltip]")&&this._hideTooltip()}),document.documentElement.appendChild(this.backdrop),document.documentElement.appendChild(this.btn),document.documentElement.appendChild(this.panel)}_showTooltip(e){const i=e.dataset.tooltip;if(!i)return;this.tooltip.textContent=i,this.tooltip.style.left="",this.tooltip.style.right="";const t=e.getBoundingClientRect(),n=this.panel.dataset.size==="mini",o=this.config.position.includes("right");if(n){const r=t.top+t.height/2;this.tooltip.style.top=`${r}px`,this.tooltip.style.transform="translateY(-50%)",o?this.tooltip.style.right=`${window.innerWidth-t.left+8}px`:this.tooltip.style.left=`${t.right+8}px`}else this.tooltip.style.left=`${t.left+t.width/2}px`,this.tooltip.style.top=`${t.top-6}px`,this.tooltip.style.transform="translate(-50%, -100%)";this.tooltip.classList.add("visible")}_hideTooltip(){this.tooltip.classList.remove("visible")}togglePanel(){this.isOpen?this.closePanel():this.openPanel()}openPanel(){this.isOpen=!0,this.panel.classList.add("open"),this.backdrop.classList.add("open"),this.btn.setAttribute("aria-expanded","true"),X(this.panel,this.btn,this.config.position),this.trackEvent("opened"),requestAnimationFrame(()=>{const e=this.panel.querySelector('button:not([disabled]), [href]:not([disabled]), [tabindex]:not([tabindex="-1"])');e==null||e.focus()})}closePanel(){this._closeLangDropdown(),this.isOpen=!1,this.panel.classList.remove("open"),this.backdrop.classList.remove("open"),this.btn.setAttribute("aria-expanded","false"),this._hideTooltip(),this.trackEvent("closed"),this.btn.focus()}trapFocus(e){const i=Array.from(this.panel.querySelectorAll('button:not([disabled]), [href], [tabindex]:not([tabindex="-1"])')).filter(o=>o.offsetParent!==null);if(i.length===0)return;const t=i[0],n=i[i.length-1];e.shiftKey?document.activeElement===t&&(e.preventDefault(),n.focus()):document.activeElement===n&&(e.preventDefault(),t.focus())}announce(e){this.liveRegion.textContent="",requestAnimationFrame(()=>{this.liveRegion.textContent=e})}toggleFeature(e){var l;const i=this.activeFeatures.has(e),t=O[e],n=Q[e];i?(t.disable(),this.activeFeatures.delete(e),n&&this.featureLevels.delete(e),this.trackEvent("feature_disabled",e)):(t.enable(n?1:void 0),this.activeFeatures.add(e),n&&this.featureLevels.set(e,1),this.trackEvent("feature_enabled",e));const o=this.panel.querySelector(`[data-feature="${e}"]`);o&&(o.classList.toggle("active",!i),o.setAttribute("aria-pressed",String(!i)),n&&(i?delete o.dataset.level:o.dataset.level="1")),o&&this._applyFeatureLabel(e,i?0:1,o);const r=(l=this._labels[e])!=null?l:e;this.announce(`${r} ${i?"disabled":"enabled"}`),this.updateActiveBadge(),this.saveCurrentPrefs()}cycleFeatureLevel(e){var c,d,u;const i=Q[e];if(!i){this.toggleFeature(e);return}const t=O[e],n=(c=this.featureLevels.get(e))!=null?c:0,o=n>=i?0:n+1;o===0?(t.disable(),this.activeFeatures.delete(e),this.featureLevels.delete(e),this.trackEvent("feature_disabled",e)):(t.enable(o),this.activeFeatures.add(e),this.featureLevels.set(e,o),this.trackEvent("feature_enabled",e));const r=this.panel.querySelector(`[data-feature="${e}"]`);r&&(r.classList.toggle("active",o>0),r.setAttribute("aria-pressed",String(o>0)),o>0?r.dataset.level=String(o):delete r.dataset.level),r&&this._applyFeatureLabel(e,o,r);const l=(d=this._labels[e])!=null?d:e,s=e==="colorBlindMode"&&o>0?`${l}: ${this._cbmTypeName(o)}`:e==="screenReader"&&o>0?`${l}: ${(u=ce[o])!=null?u:"level "+String(o)}`:o>0?`${l} level ${o} of ${i}`:`${l} disabled`;this.announce(s),this.updateActiveBadge(),this.saveCurrentPrefs()}resetAll(){var i,t;for(const n of[...this.activeFeatures]){O[n].disable(),this.activeFeatures.delete(n);const r=this.panel.querySelector(`[data-feature="${n}"]`);if(r){if(r.classList.remove("active"),r.setAttribute("aria-pressed","false"),delete r.dataset.level,n==="colorBlindMode"){const l=r.querySelector(".inculva-feature-label");l&&(l.textContent=(i=this._labels.colorBlindMode)!=null?i:"Color Blind")}if(n==="screenReader"){const l=r.querySelector(".inculva-feature-label");l&&(l.textContent=(t=this._labels.screenReader)!=null?t:"Screen reader")}}}this.featureLevels.clear();for(const n of[...this.activeProfiles]){const o=this.panel.querySelector(`[data-profile="${n}"]`);o==null||o.classList.remove("active"),o==null||o.setAttribute("aria-pressed","false")}this.activeProfiles.clear();const e=this.panel.querySelector(".inculva-cbm-selector");e==null||e.classList.remove("visible"),this.updateActiveBadge(),this.saveCurrentPrefs(),this.announce("All accessibility features reset")}switchTab(e){for(const t of this.panel.querySelectorAll(".inculva-tab-btn")){const n=t.dataset.inculvaTab===e;t.classList.toggle("active",n),t.setAttribute("aria-selected",String(n))}const i=this.panel.querySelector(".inculva-feature-grid");i&&(i.dataset.activeTab=e),X(this.panel,this.btn,this.config.position)}switchSize(e){const i=e==="xl"?"large":e;this.panel.dataset.size=i;for(const t of this.panel.querySelectorAll(".inculva-size-btn"))t.classList.toggle("active",t.dataset.size===i);X(this.panel,this.btn,this.config.position),this.saveCurrentPrefs()}_setLanguage(e){this.config.language=e,_(e),this._closeLangDropdown(),ie(this.panel,this.config.features,e,this._labels,this.config.accessibilityStatementUrl,this.config.whiteLabelText),this.updateActiveBadge(),this.saveCurrentPrefs()}_toggleLangDropdown(){const e=this.panel.querySelector(".inculva-lang-dropdown");e&&(e.classList.contains("open")?this._closeLangDropdown():this._openLangDropdown())}_openLangDropdown(){const e=this.panel.querySelector(".inculva-lang-dropdown");if(!e)return;e.classList.add("open");const i=e.querySelector(".inculva-lang-trigger");i&&i.setAttribute("aria-expanded","true");const t=e.querySelector(".inculva-lang-search");if(t){t.value="";for(const n of e.querySelectorAll(".inculva-lang-option"))n.classList.remove("inculva-hidden")}requestAnimationFrame(()=>{t==null||t.focus();const n=e.querySelector(".inculva-lang-option.active");n==null||n.scrollIntoView({block:"nearest"})})}_closeLangDropdown(){const e=this.panel.querySelector(".inculva-lang-dropdown");if(!e)return;e.classList.remove("open");const i=e.querySelector(".inculva-lang-trigger");i&&i.setAttribute("aria-expanded","false")}switchSide(){const e=this.config.position,t=e.includes("left")?e.replace("left","right"):e.replace("right","left");this.config.position=t,H(this.btn,t),H(this.panel,t);const n=t.includes("left");n?this.panel.setAttribute("data-panel-side","left"):this.panel.removeAttribute("data-panel-side"),this.isOpen&&X(this.panel,this.btn,t),ke(this.panel,n,this._labels),this.saveCurrentPrefs()}toggleProfiles(){const e=this.panel.querySelector(".inculva-profiles-toggle"),i=this.panel.querySelector(".inculva-profiles-grid");if(!e||!i)return;const t=e.getAttribute("aria-expanded")==="true";e.setAttribute("aria-expanded",String(!t)),i.hidden=t}activateProfile(e){const i=Z.find(o=>o.key===e);if(!i)return;const t=this.activeProfiles.has(e);if(t){for(const o of i.features)this.activeFeatures.has(o)&&this.toggleFeature(o);this.activeProfiles.delete(e)}else{for(const o of i.features)this.activeFeatures.has(o)||this.toggleFeature(o);this.activeProfiles.add(e)}const n=this.panel.querySelector(`[data-profile="${e}"]`);n==null||n.classList.toggle("active",!t),n==null||n.setAttribute("aria-pressed",String(!t)),this.announce(`Profile ${i.label} ${t?"deactivated":"activated"}`),this.saveCurrentPrefs()}updateActiveBadge(){var t;const e=this.activeFeatures.size;this.badge&&(this.badge.textContent=String(e),this.badge.classList.toggle("visible",e>0));const i=this.panel.querySelector(".inculva-active-count");if(i){const n=ee(this.config.language);i.textContent=`${e} ${(t=n.active)!=null?t:"active"}`,i.hidden=e===0}for(const[n,o]of Object.entries(ue)){const r=o.filter(c=>this.activeFeatures.has(c)).length,l=this.panel.querySelector(`[data-inculva-tab="${n}"]`);if(!l)continue;const s=l.querySelector(".inculva-tab-count");s&&(s.textContent=String(r),s.hidden=r===0)}}_cbmTypeName(e){var t,n;const i=ae[e-1];return i?(n=this._labels[i])!=null?n:i.charAt(0).toUpperCase()+i.slice(1):(t=this._labels.colorBlindMode)!=null?t:"Color Blind"}_applyFeatureLabel(e,i,t){var o,r,l,s,c;const n=t.querySelector(".inculva-feature-label");n&&(e==="colorBlindMode"?n.textContent=i>0?this._cbmTypeName(i):(o=this._labels.colorBlindMode)!=null?o:"Color Blind":e==="saturation"?n.textContent=i===1?(r=this._labels.highContrast)!=null?r:"High Contrast":(l=this._labels.saturation)!=null?l:"Contrast+":e==="screenReader"&&(n.textContent=i>0?(s=ce[i])!=null?s:"Screen reader":(c=this._labels.screenReader)!=null?c:"Screen reader"))}selectColorBlindType(e){Ee(e);const i=this.panel.querySelector(".inculva-cbm-selector");if(i)for(const t of i.querySelectorAll("[data-cbm-type]")){const n=t.dataset.cbmType===e;t.classList.toggle("active",n),t.setAttribute("aria-pressed",String(n))}if(!this.activeFeatures.has("colorBlindMode")){this.toggleFeature("colorBlindMode");return}this.announce(`Color blind mode: ${e}`),this.saveCurrentPrefs()}saveCurrentPrefs(){var i;if(this._restoring)return;const e={};for(const t of this.activeFeatures){const n=this.featureLevels.get(t);if(e[t]=n!=null?n:!0,n!==void 0){const o=this.panel.querySelector(`[data-feature="${t}"]`),r=o==null?void 0:o.querySelector(".inculva-feature-label");r!=null&&r.textContent&&(e[`${t}Label`]=r.textContent)}}e.colorBlindType=Re(),e.widgetSize=(i=this.panel.dataset.size)!=null?i:"regular",e.widgetPosition=this.config.position,e.widgetLanguage=this.config.language,e.activeProfiles=Array.from(this.activeProfiles),Li(e)}restorePrefs(){this._restoring=!0;const e=Bi(),i=e.widgetLanguage;typeof i=="string"&&J.some(o=>o.code===i)&&(this.config.language=i,_(i),ie(this.panel,this.config.features,i,this._labels,this.config.accessibilityStatementUrl,this.config.whiteLabelText));const t=e.widgetPosition;if(typeof t=="string"&&["bottom-right","bottom-left","top-right","top-left"].includes(t)){this.config.position=t,H(this.btn,this.config.position),H(this.panel,this.config.position);const o=this.config.position.includes("left");o?this.panel.setAttribute("data-panel-side","left"):this.panel.removeAttribute("data-panel-side"),ke(this.panel,o,this._labels)}typeof e.widgetSize=="string"&&["mini","regular","large"].includes(e.widgetSize)&&this.switchSize(e.widgetSize);const n=e.activeProfiles;if(Array.isArray(n)){for(const o of n)if(typeof o=="string"&&Z.find(r=>r.key===o)){this.activeProfiles.add(o);const r=this.panel.querySelector(`[data-profile="${o}"]`);r==null||r.classList.add("active"),r==null||r.setAttribute("aria-pressed","true")}}for(const[o,r]of Object.entries(e)){if(o==="colorBlindType"||o.endsWith("Label")||o==="widgetSize"||o==="widgetPosition"||o==="widgetLanguage"||o==="activeProfiles"||!(o in O))continue;const l=o,s=Q[l];if(s&&typeof r=="number"&&r>=1&&r<=s){O[l].enable(r),this.activeFeatures.add(l),this.featureLevels.set(l,r);const c=this.panel.querySelector(`[data-feature="${l}"]`);if(c){c.classList.add("active"),c.setAttribute("aria-pressed","true"),c.dataset.level=String(r);const d=e[`${l}Label`];if(typeof d=="string"){const u=c.querySelector(".inculva-feature-label");u&&(u.textContent=d)}}}else(r===!0||typeof r=="number"&&r>=1)&&this.toggleFeature(l)}this.updateActiveBadge(),this._restoring=!1,this.saveCurrentPrefs()}async fetchRemoteConfig(){var e;try{const i=await fetch(`${this.apiBase}/widget/config/${this.config.siteId}`);if(i.status===404||i.status===403)return console.warn(`[Inculva] Widget disabled — ${i.status===404?"site not found":"domain not authorized"}.`),!1;if(!i.ok)return!0;const t=await i.json(),n=(e=t.data)!=null?e:t;return n.primaryColor&&(this.config.primaryColor=n.primaryColor),n.features&&(this.config.features={...this.config.features,...n.features}),n.language&&(this.config.language=n.language),n.position&&(this.config.position=n.position),n.theme&&(this.config.theme=n.theme),n.accessibilityStatementUrl!==void 0&&(this.config.accessibilityStatementUrl=n.accessibilityStatementUrl),n.whiteLabelText!==void 0&&(this.config.whiteLabelText=n.whiteLabelText),n.borderRadius!==void 0&&(this.config.borderRadius=n.borderRadius),n.buttonSize!==void 0&&(this.config.buttonSize=n.buttonSize),n.fontFamily!==void 0&&(this.config.fontFamily=n.fontFamily),n.headerBgColor!==void 0&&(this.config.headerBgColor=n.headerBgColor),n.footerBgColor!==void 0&&(this.config.footerBgColor=n.footerBgColor),n.labels&&(this.labels=n.labels),!0}catch(i){return!0}}applyConfigToDOM(){this.config.borderRadius!==void 0&&document.documentElement.style.setProperty("--inculva-border-radius",`${this.config.borderRadius}px`),this.config.buttonSize!==void 0&&document.documentElement.style.setProperty("--inculva-button-size",this.config.buttonSize==="small"?"44px":this.config.buttonSize==="large"?"64px":"52px"),this.config.fontFamily!==void 0&&this.config.fontFamily!=="system"&&document.documentElement.style.setProperty("--inculva-font",this.getFontStack(this.config.fontFamily)),this.config.headerBgColor&&document.documentElement.style.setProperty("--inculva-header-bg",this.config.headerBgColor),this.config.footerBgColor&&document.documentElement.style.setProperty("--inculva-footer-bg",this.config.footerBgColor),ie(this.panel,this.config.features,this.config.language,this._labels,this.config.accessibilityStatementUrl,this.config.whiteLabelText),this.config.position.includes("left")?this.panel.setAttribute("data-panel-side","left"):this.panel.removeAttribute("data-panel-side")}getFontStack(e){var t;return(t={inter:"'Inter', sans-serif",roboto:"'Roboto', sans-serif",opensans:"'Open Sans', sans-serif"}[e])!=null?t:"inherit"}trackEvent(e,i){const t={siteId:this.config.siteId,sessionId:Ri(),event:e,feature:i,timestamp:new Date().toISOString()};fetch(`${this.apiBase}/widget/events`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t),credentials:"omit",keepalive:!0}).catch(()=>{})}}const j=document.currentScript;function Me(){var i,t,n;const a=(n=(i=j==null?void 0:j.dataset.siteId)!=null?i:j==null?void 0:j.getAttribute("data-site-id"))!=null?n:(t=window.__INCULVA_PREVIEW_CONFIG__)==null?void 0:t.siteId;if(!a){console.warn("[Inculva] Missing data-site-id attribute on script tag.");return}const e=window.__INCULVA_PREVIEW_CONFIG__;new Ce({...e!=null?e:{},siteId:a})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Me):Me(),window.InculvaWidget=Ce})();
