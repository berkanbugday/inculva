...
const PRODUCT_TO_PLAN: Record<string, Plan> = {
    ...
    [process.env["POLAR_SMALL_YEARLY_PRODUCT_ID"] ?? "~sma"]: "small",
    [process.env["POLAR_MEDIUM_MONTHLY_PRODUCT_ID"] ?? "~mm"]: "medium",
    [process.env["POLAR_MEDIUM_YEARLY_PRODUCT_ID"] ?? "~mma"]: "medium",
    [process.env["POLAR_LARGE_MONTHLY_PRODUCT_ID"] ?? "~lm"]: "large",
    [process.env["POLAR_LARGE_YEARLY_PRODUCT_ID"] ?? "~lma"]: "large",
};
