...
const PLAN_DESC: Record<string, string> = {
  small: "Perfect for small websites",
  medium: "Growing businesses & agencies",
  large: "High-traffic & enterprise sites",
};
    ...
    <div className="space-y-5">
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
            Subscribe anytime — cancel at end of billing period
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 items-stretch">
        {shown.map((product) => {
          ...
          const savings = interval === "year" && monthly ? monthly * 12 - annualTotal : 0;
