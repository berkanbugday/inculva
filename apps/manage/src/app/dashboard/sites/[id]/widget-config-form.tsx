...
const FEATURES: { key: keyof WidgetFeatures; label: string; description: string; wcag?: string }[] = [
  ...
  { key: "readingGuide", label: "Reading Guide", description: "Horizontal amber line that follows the cursor — helps dyslexic users track their reading position" },
  ...
  { key: "pauseAnimations", label: "Pause Animations", description: "Freezes all CSS animations and disables transitions — essential for photosensitive users", wcag: "2.3.3" },
  { key: "textSpacing", label: "Text Spacing", description: "Increases line-height, letter-spacing, and word-spacing (4 levels per WCAG 1.4.12)", wcag: "1.4.12" },
  { key: "highlightLinks", label: "Highlight Links", description: "Forces underline + bold + outline on all anchor tags — makes links visible without relying on color", wcag: "1.4.1" },
...
// Extended features — additional accessibility aids
const EXTENDED_FEATURES: { key: keyof Config; label: string; description: string; wcag?: string }[] = [
  { key: "blueLightFilter", label: "Blue Light Filter", description: "Adds a warm sepia tint to reduce blue light — eases eye fatigue during prolonged screen use", wcag: "1.4.3" },
  { key: "hideImages", label: "Hide Images", description: "Makes all images invisible (preserving layout) — removes visual distractions for users with cognitive disabilities" },
  { key: "darkMode", label: "Dark Mode", description: "CSS invert + hue-rotate trick to create a dark theme — images are counter-inverted to keep natural colors" },
  { key: "contentMagnifier", label: "Content Magnifier", description: "Circular lens that scales hovered elements (4 levels: 1.15×–1.5×) — for low-vision users who need local zoom" },
  { key: "lineHeight", label: "Line Height", description: "Increases line-height (4 levels: 1.6–2.6) — more vertical breathing room between lines of text", wcag: "1.4.12" },
  { key: "highlightTitles", label: "Highlight Titles", description: "Adds a visible outline around all h1–h6 headings — helps users with cognitive disabilities identify page structure" },
  { key: "toolTips", label: "Alt Text Tooltips", description: "Shows image alt text on hover as a tooltip — coming soon" },
  { key: "sustainabilityMode", label: "Sustainability Mode", description: "Energy-saving mode that reduces motion and background processing — coming soon" },
  { key: "dictionary", label: "Dictionary", description: "Highlight any word to see its definition — coming soon" },
];
