...
const rules = [
  // ─── 1.4.1 Use of Color ───
  {
    ...
    content: {
      ...
      tr: [
        ...
        numbered(
          "Tarayıcı DevTools'unda sayfaya gri tonlama filtresi uygulayın: filter: grayscale(100%). Tüm sayfada gezinin ve bilgilerin anlaşılabilir olduğunu doğrulayın.",
        ),
        numbered(
          "Doğrulama hatası olan tüm form alanlarını kontrol edin. Hatalar renk değişikliğine ek olarak simge, metin veya kenarlıkla belirtiliyor mu?",
        ),
        numbered(
          "Grafikleri ve veri görselleştirmelerini inceleyin. Her veri serisi, renginin yanı sıra benzersiz bir desene, etikete veya şekle sahip mi?",
        ),
        numbered(
          "Metin içindeki bağlantıları gözden geçirin. Alt çizgi veya renkten başka bir ayırt edici öğe var mı?",
        ),
        numbered(
          "axe DevTools çalıştırın ve link-in-text-block kural ihlallerini kontrol edin.",
        ),
    ...
    resources: [
      ...
      {
        title: "WebAIM: Visual Disabilities - Color-blindness",
      ...
      {
        title: "Deque: axe-core link-in-text-block",
        url: "https://dequeuniversity.com/rules/axe/4.8/link-in-text-block",
        source: "Deque",
        language: "en",
        _key: "r141dequ",
      },
      {
        title: "MDN: color-scheme and accessibility",
      ...
      {
        title: "Techniques for WCAG 2 - F73: Using color alone for links",
    ...
    seo: {
      en: {
        ...
        metaDescription:
          "Learn how to meet WCAG 1.4.1 Use of Color. Ensure color is never the only way to convey information, with practical code examples and testing techniques.",
      },
      tr: {
        metaTitle: "WCAG 1.4.1 Renk Kullanımı – Erişilebilirlik Rehberi",
        metaDescription:
          "WCAG 1.4.1 Renk Kullanımı ölçütünü nasıl karşılayacağınızı öğrenin. Rengin tek bilgi aktarma yolu olmamasını sağlayın.",
      },
    },
  },
  ...
  // ─── 1.4.2 Audio Control ───
  {
    ...
    resources: [
      ...
      {
        title: "Deque: axe-core no-autoplay-audio",
        url: "https://dequeuniversity.com/rules/axe/4.8/no-autoplay-audio",
        source: "Deque",
        language: "en",
        _key: "r142dequ",
      },
      {
        title: "MDN: HTMLMediaElement.autoplay",
      ...
      {
        title:
          "Techniques for WCAG 2 - G170: Providing a control near the top of the page",
    ...
    seo: {
      en: {
        ...
        metaDescription:
          "Learn how to meet WCAG 1.4.2 Audio Control. Stop auto-playing audio from interfering with screen readers. Code examples and testing steps included.",
      },
      tr: {
        metaTitle: "WCAG 1.4.2 Ses Kontrolü – Erişilebilirlik Rehberi",
        metaDescription:
          "WCAG 1.4.2 Ses Kontrolü ölçütünü nasıl karşılayacağınızı öğrenin. Otomatik çalan sesin ekran okuyucularla çakışmasını önleyin.",
      },
    },
  },
  ...
  // ─── 1.4.3 Contrast (Minimum) ─── (Comprehensive)
  {
    ...
    resources: [
      ...
      {
        title: "Deque: axe-core color-contrast",
      ...
      {
        title: "Colour Contrast Analyser (CCA) by TPGi",
    ...
    seo: {
      en: {
        ...
        metaDescription:
          "Master WCAG 1.4.3 Contrast (Minimum). Achieve the 4.5:1 ratio for text with CSS examples, testing tools, and a contrast-safe color system approach.",
      },
      tr: {
        metaTitle: "WCAG 1.4.3 Kontrast (Minimum) – Erişilebilirlik Rehberi",
        metaDescription:
          "WCAG 1.4.3 Kontrast (Minimum) ölçütünde ustalaşın. CSS örnekleri, test araçları ve kontrast güvenli renk sistemi ile 4.5:1 oranını sağlayın.",
      },
    },
  },
  ...
  // ─── 1.4.4 Resize Text ───
  {
    ...
    content: {
      ...
      tr: [
        ...
        heading("Nasıl Test Edilir"),
        numbered(
          "Sayfayı masaüstü tarayıcısında açın ve Ctrl+Plus (Mac'te Cmd+Plus) ile %200 yakınlaştırın.",
        ),
        numbered(
          "Tüm metin içeriğinin hâlâ görünür olduğunu ve hiçbir metnin kırpılmadığını veya diğer öğelerin arkasında gizlenmediğini doğrulayın.",
        ),
        numbered(
          "Tüm etkileşimli kontrollerin hâlâ kullanılabilir olduğunu ve işlevsellik kaybı olmadığını sağlayın.",
        ),
        numbered(
          "Sayfanın yatay kaydırma gerektirmek yerine içeriği yeniden akıttığını kontrol edin.",
        ),
        numbered(
          '<meta name="viewport"> etiketini inceleyin. user-scalable=no veya 2\'den küçük maximum-scale içermemelidir.',
        ),
    ...
    resources: [
      {
        title: "Understanding SC 1.4.4: Resize Text",
      ...
      {
        title: "WebAIM: Fonts and Readability",
      ...
      {
        title: "Deque: axe-core meta-viewport",
        url: "https://dequeuniversity.com/rules/axe/4.8/meta-viewport",
        source: "Deque",
        language: "en",
        _key: "r144dequ",
      },
      ...
      {
        title: "Techniques for WCAG 2 - G179: Ensuring no loss of content",
        url: "https://www.w3.org/WAI/WCAG22/Techniques/general/G179",
        source: "W3C",
        language: "en",
        _key: "r144w3c2",
      },
    ...
    seo: {
      en: {
        ...
        metaDescription:
          "Meet WCAG 1.4.4 Resize Text. Ensure text scales to 200% without breaking layout. Fix viewport meta, use rem units, and test zoom properly.",
      },
      tr: {
        metaTitle: "WCAG 1.4.4 Metin Boyutlandırma – Erişilebilirlik Rehberi",
        metaDescription:
          "WCAG 1.4.4 Metin Boyutlandırma ölçütünü karşılayın. Metnin düzen bozulmadan %200 ölçeklenmesini sağlayın.",
      },
    },
  },
  ...
  // ─── 1.4.5 Images of Text ───
  {
    ...
    resources: [
      {
        title: "Understanding SC 1.4.5: Images of Text",
      ...
      {
        title: "WebAIM: Images - Images of Text",
        url: "https://webaim.org/techniques/images/#text_images",
        source: "WebAIM",
        language: "en",
        _key: "r145waim",
      },
      {
        title: "Deque University: Images of Text",
        url: "https://dequeuniversity.com/rules/axe/4.8/image-alt",
        source: "Deque",
        language: "en",
        _key: "r145dequ",
      },
      ...
      {
        title: "CSS Tricks: Gradient Text",
        url: "https://css-tricks.com/snippets/css/gradient-text/",
        source: "CSS-Tricks",
        language: "en",
        _key: "r145csst",
      },
    ...
    seo: {
      en: {
        ...
        metaDescription:
          "Meet WCAG 1.4.5 Images of Text. Replace image-based text with styled HTML using modern CSS techniques for better accessibility and SEO.",
      },
      tr: {
        metaTitle: "WCAG 1.4.5 Metin Görselleri – Erişilebilirlik Rehberi",
        metaDescription:
          "WCAG 1.4.5 Metin Görselleri ölçütünü karşılayın. Modern CSS teknikleriyle görsel tabanlı metni stillendirilmiş HTML ile değiştirin.",
      },
    },
  },
  ...
  // ─── 1.4.6 Contrast (Enhanced) ───
  {
    ...
    resources: [
      ...
      {
        title: "Deque: axe-core color-contrast-enhanced",
        url: "https://dequeuniversity.com/rules/axe/4.8/color-contrast-enhanced",
        source: "Deque",
        language: "en",
        _key: "r146dequ",
      },
      {
        title: "MDN: Using relative color values",
      ...
      {
        title: "Techniques for WCAG 2 - G17: Ensuring a 7:1 contrast ratio",
    ...
    seo: {
      en: {
        ...
        metaDescription:
          "Achieve WCAG 1.4.6 Enhanced Contrast with 7:1 ratio. AAA-level color guidance with CSS examples and testing tools for maximum readability.",
      },
      tr: {
        metaTitle: "WCAG 1.4.6 Kontrast (Gelişmiş) – AAA Rehberi",
        metaDescription:
          "WCAG 1.4.6 Gelişmiş Kontrast ölçütünü 7:1 oranıyla sağlayın. Maksimum okunabilirlik için AAA düzeyinde renk rehberi.",
      },
    },
  },
  ...
  // ─── 1.4.7 Low or No Background Audio ───
  {
    ...
    content: {
      ...
      tr: [
        heading("Bu Kural Ne Anlama Gelir"),
        p(
          "WCAG 1.4.7, podcast'ler, anlatımlı videolar veya kaydedilmiş sunumlar gibi esas olarak konuşma içeren önceden kaydedilmiş ses içeriğine uygulanır. Konuşma ile birlikte arka plan sesleri (müzik, ortam gürültüsü, ses efektleri) bulunduğunda, bu arka plan sesleri ön plan konuşma içeriğinden en az 20 desibel daha sessiz olmalıdır. Alternatif olarak arka plan seslerini tamamen kapatmak için bir mekanizma sağlanabilir.",
        ),
        p(
          "20 dB fark, arka plan sesinin konuşmadan yaklaşık dört kat daha sessiz olduğu anlamına gelir. Bu, işitme güçlüğü çeken kişilerin konuşulan kelimeleri arka plan gürültüsünden ayırt edebilmesini sağlar. Ölçüt, doğası gereği esas olarak müzikal olan seslere veya canlı seslere uygulanmaz.",
        ),

        heading("Neden Önemlidir"),
        p(
          "İşitme bozukluğu olan, işitsel işleme bozukluğu bulunan veya işitme güçlüğü çeken kişiler, arka plan sesi konuşmayla rekabet ettiğinde ciddi zorluk yaşar. Orta düzeyde bile arka plan müziği konuşma frekanslarını maskeleyebilir ve içeriği bu kullanıcılar için anlaşılmaz hâle getirebilir.",
        ),
        p(
          "Bu aynı zamanda net konuşmaya ihtiyaç duyan ana dili farklı olan konuşmacılar ve gürültülü ortamlardaki kullanıcılar için de faydalıdır.",
        ),

        heading("İlgili axe-core Kuralları"),
        p(
          "1.4.7 için otomatik axe-core kuralı yoktur. Bu ölçüt, otomatik araçların ön plan konuşması ile arka plan sesi arasındaki göreceli hacmi ölçememesi nedeniyle manuel ses analizi gerektirir.",
        ),

        heading("Nasıl Test Edilir"),
        numbered(
          "Ses içeriğini dinleyin ve konuşma ile birlikte arka plan seslerinin olup olmadığını not edin.",
        ),
        numbered(
          "Arka plan sesleri varsa, konuşma ve arka plan dB seviyelerini ayrı ayrı ölçmek için ses analiz yazılımı (Audacity gibi) kullanın.",
        ),
        numbered(
          "Arka planın konuşma tepe seviyelerinden en az 20 dB düşük olduğunu doğrulayın.",
        ),
        numbered(
          "Alternatif olarak, konuşmayı koruyarak arka plan sesini devre dışı bırakan bir mekanizmanın olup olmadığını kontrol edin.",
        ),
        numbered(
          "İşitme güçlüğü olan birinin dinlemesini ve konuşmanın açıkça ayırt edilebildiğini onaylamasını sağlayın.",
        ),

        heading("Nasıl Düzeltilir"),
        p(
          "Ses prodüksiyonu sırasında arka plan seviyelerini uygun şekilde ayarlayın:",
        ),
        code(
          '<!-- Mümkün olduğunda ayrı ses parçaları sağlayın -->\n<audio controls>\n  <source src="yalnızca-anlatim.mp3" type="audio/mpeg" />\n</audio>\n<label>\n  <input type="checkbox" id="bg-audio-toggle" />\n  Arka plan müziğini etkinleştir\n</label>',
          "html",
        ),
        p(
          "Konuşma segmentleri sırasında arka plan sesini otomatik olarak düşürmek için ses kısma (audio ducking) tekniği kullanın. Prodüksiyon iş akışlarında, konuşmanın arka plan seviyesinin düşmesini tetiklediği yan zincir sıkıştırma uygulayın.",
        ),

        heading("Sık Yapılan Hatalar"),
        bullet(
          "Arka plan müziğinin anlatım ile aynı seviyede olması, işitme engelli kullanıcıların konuşmayı ayırt etmesini zorlaştırır.",
        ),
        bullet(
          "Konuşma sırasında ani yükselen ve kelimeleri geçici olarak maskeleyen ortam ses efektleri.",
        ),
        bullet(
          "Konuşma başladığında aynı ses seviyesinde devam eden yüksek müzikli podcast giriş bölümleri.",
        ),
        bullet(
          "Ayrı parçalar teknik olarak mevcut olduğunda arka plan sesini devre dışı bırakma seçeneği bulunmaması.",
        ),
        bullet(
          "Bu gereksinimi gerçekte muaf olan ağırlıklı olarak müzikal içeriğe uygulamak.",
        ),
      ],
    },
    resources: [
      {
        title: "Understanding SC 1.4.7: Low or No Background Audio",
      ...
      {
        title: "WebAIM: Audio and Video Accessibility",
        url: "https://webaim.org/techniques/captions/",
        source: "WebAIM",
        language: "en",
        _key: "r147waim",
      ...
      {
        title: "Techniques for WCAG 2 - G56: Mixing audio files",
    ...
    seo: {
      en: {
        ...
        metaDescription:
          "Meet WCAG 1.4.7 by keeping background audio 20 dB below speech. Audio mixing tips and testing techniques for clear, accessible speech content.",
      },
      tr: {
        metaTitle: "WCAG 1.4.7 Düşük veya Arka Plan Sesi Yok – Rehber",
        metaDescription:
          "WCAG 1.4.7 ölçütünü, arka plan sesini konuşmadan 20 dB aşağıda tutarak karşılayın. Erişilebilir ses içeriği için karıştırma ipuçları.",
      },
    },
  },
  ...
  // ─── 1.4.8 Visual Presentation ───
  {
    ...
    content: {
      ...
      tr: [
        ...
        heading("Nasıl Test Edilir"),
        numbered(
          "Gövde metninin maksimum satır genişliğini ölçün. En uzun satırdaki karakterleri sayın — 80 karakteri aşmamalıdır.",
        ),
        numbered(
          "Gövde metin bloklarında text-align özelliğini kontrol edin. justify olarak ayarlanmamış olmalıdır.",
        ),
        numbered(
          "Gövde metindeki line-height değerini inceleyin. En az 1.5 (%150) olmalıdır.",
        ),
        numbered(
          "Paragraflar arasındaki boşluğu kontrol edin. line-height değerinin en az 1.5 katı olmalıdır.",
        ),
        numbered(
          "Kullanıcının tarayıcı ayarları veya sağlanan bir arayüz mekanizması ile ön plan ve arka plan renklerini geçersiz kılıp kılamadığını test edin.",
        ),
    ...
    resources: [
      {
        title: "Understanding SC 1.4.8: Visual Presentation",
      ...
      {
        title: "WebAIM: Typefaces and Fonts",
        url: "https://webaim.org/techniques/fonts/",
        source: "WebAIM",
        language: "en",
        _key: "r148waim",
      ...
      {
        title: "Deque: Text Readability",
        url: "https://dequeuniversity.com/checklists/web/text",
        source: "Deque",
        language: "en",
        _key: "r148dequ",
      },
      {
        title: "MDN: line-height - CSS",
      ...
      {
        title: "Techniques for WCAG 2 - C21: Specifying line spacing in CSS",
    ...
    seo: {
      en: {
        ...
        metaDescription:
          "Meet WCAG 1.4.8 Visual Presentation. Control line length, spacing, justification, and color customization for optimal text readability.",
      },
      tr: {
        metaTitle: "WCAG 1.4.8 Görsel Sunum – AAA Rehberi",
        metaDescription:
          "WCAG 1.4.8 Görsel Sunum ölçütünü karşılayın. Satır uzunluğu, aralık, yaslama ve renk özelleştirmesini kontrol edin.",
      },
    },
  },
  ...
  // ─── 1.4.9 Images of Text (No Exception) ───
  {
    ...
    content: {
      en: [
        ...
        heading("How to Test"),
        numbered(
          "Audit all images on the page using DevTools to identify images containing text.",
        ),
        numbered(
          "For each image of text, ask: Is this a logotype? If yes, it is exempt.",
        ),
        numbered(
          "For non-logo images of text, ask: Is the specific visual presentation the actual information? If showing what a typeface looks like, it is exempt. If it is a heading or button, it fails.",
        ),
        numbered(
          "Verify that no functional text (headings, buttons, navigation, labels) is rendered as images.",
        ),
    ...
    resources: [
      {
        title: "Understanding SC 1.4.9: Images of Text (No Exception)",
      ...
      {
        title: "WebAIM: Images - Appropriate Use",
      ...
      {
        title: "Deque University: Images of Text",
        url: "https://dequeuniversity.com/checklists/web/images",
        source: "Deque",
        language: "en",
        _key: "r149dequ",
      },
      {
        title: "MDN: -webkit-text-stroke",
      ...
      {
        title: "CSS Tricks: Techniques for Accessible Text Over Images",
        url: "https://css-tricks.com/design-considerations-text-images/",
        source: "CSS-Tricks",
        language: "en",
        _key: "r149csst",
      },
    ...
    seo: {
      en: {
        ...
        metaDescription:
          "Meet WCAG 1.4.9 Images of Text (No Exception). Eliminate all non-essential images of text using CSS techniques for AAA compliance.",
      },
      tr: {
        metaTitle: "WCAG 1.4.9 Metin Görselleri (İstisna Yok) – Rehber",
        metaDescription:
          "WCAG 1.4.9 ölçütünü karşılayın. AAA uyumu için CSS teknikleriyle tüm zorunlu olmayan metin görsellerini ortadan kaldırın.",
      },
    },
  },
  ...
  // ─── 1.4.10 Reflow ─── (Comprehensive)
  {
    ...
    content: {
      en: [
        ...
        heading("How to Test"),
        numbered(
          "In Chrome DevTools, open the Device toolbar (Ctrl+Shift+M / Cmd+Shift+M) and set a custom viewport of 320px wide with no height restriction.",
        ),
        numbered(
          "Alternatively, zoom the desktop browser to 400% (1280px / 4 = 320px effective width).",
        ),
        numbered(
          "Scroll through the entire page vertically. No horizontal scrollbar should appear and no content should be hidden off-screen to the right.",
        ),
        numbered(
          "Verify that all interactive elements are usable: buttons are tappable, form fields are accessible, navigation works.",
        ),
        numbered(
          "Check that no text is clipped, truncated, or overlapping other content.",
        ),
        numbered(
          "Test both orientations if the content has a horizontal layout variant.",
        ),
        numbered(
          "For data tables, verify they either convert to a stacked layout, use a horizontally scrollable container (while surrounding content reflows), or provide a responsive alternative view.",
        ),
        numbered(
          "Test key user flows: navigation, search, forms, checkout — ensure every step works at 320px wide.",
        ),
    ...
    resources: [
      {
        title: "Understanding SC 1.4.10: Reflow",
      ...
      {
        title: "WebAIM: Responsive Design and Zoom",
        url: "https://webaim.org/techniques/responsivedesign/",
        source: "WebAIM",
        language: "en",
        _key: "r1410wai",
      },
      {
        title: "Deque: WCAG 2.1 Reflow",
        url: "https://dequeuniversity.com/rules/axe/4.8/meta-viewport",
        source: "Deque",
        language: "en",
        _key: "r1410deq",
      ...
      {
        title: "Techniques for WCAG 2 - C31: Using CSS Flexbox",
    ...
    seo: {
      en: {
        ...
        metaDescription:
          "Master WCAG 1.4.10 Reflow. Ensure content works at 320px width without horizontal scrolling using responsive CSS grid, flexbox, and mobile-first design.",
      },
      tr: {
        metaTitle: "WCAG 1.4.10 Yeniden Akış – Erişilebilirlik Rehberi",
        metaDescription:
          "WCAG 1.4.10 Yeniden Akış ölçütünde ustalaşın. Duyarlı CSS grid, flexbox ve mobil öncelikli tasarımla 320px genişlikte içeriğin çalışmasını sağlayın.",
      },
    },
  },
  ...
  // ─── 1.4.11 Non-text Contrast ───
  {
    ...
    content: {
      ...
      tr: [
        ...
        heading("Nasıl Test Edilir"),
        numbered(
          "Tüm etkileşimli kullanıcı arayüzü bileşenlerini tanımlayın: düğmeler, giriş alanları, seçim kutuları, onay kutuları, radyo düğmeleri, kaydırıcılar, aç/kapa düğmeleri, bağlantılar, sekmeler.",
        ),
        numbered(
          "Her bileşen için, renk kontrast aracı kullanarak görsel sınırının bitişik arka plana karşı kontrastını kontrol edin.",
        ),
        numbered(
          "Odak göstergelerini test edin. Sayfada sekme tuşuyla ilerleyin ve odak halkasının arka plana karşı en az 3:1 kontrasta sahip olduğunu doğrulayın.",
        ),
        numbered(
          "Anlamlı simgeleri ve grafik öğeleri kontrol edin. Simge rengini arka planıyla karşılaştırmak için renk seçici kullanın.",
        ),
        numbered(
          "Grafik öğelerinin (çubuklar, çizgiler, pasta dilimleri) bitişik renklere karşı 3:1 kontrasta sahip olduğunu doğrulayın.",
        ),
    ...
    resources: [
      ...
      {
        title: "Deque: Non-text Contrast Guide",
        url: "https://dequeuniversity.com/checklists/web/color-contrast",
        source: "Deque",
        language: "en",
        _key: "r1411deq",
      },
      {
        title: "MDN: outline - CSS",
      ...
      {
        title:
          "Techniques for WCAG 2 - G209: Sufficient contrast for active UI",
    ...
    seo: {
      en: {
        ...
        metaDescription:
          "Meet WCAG 1.4.11 Non-text Contrast. Ensure UI components, focus indicators, and graphics meet the 3:1 ratio with CSS examples.",
      },
      tr: {
        metaTitle: "WCAG 1.4.11 Metin Dışı Kontrast – Erişilebilirlik Rehberi",
        metaDescription:
          "WCAG 1.4.11 Metin Dışı Kontrast ölçütünü karşılayın. Arayüz bileşenleri, odak göstergeleri ve grafiklerin 3:1 oranını sağlayın.",
      },
    },
  },
  ...
  // ─── 1.4.12 Text Spacing ───
  {
    ...
    content: {
      en: [
        ...
        heading("How to Test"),
        numbered(
          "Apply the following CSS overrides to the page using a bookmarklet, browser extension, or DevTools:",
        ),
        code(
        ...
        numbered(
          "Scan the entire page for content that is now clipped, truncated, overlapping, or hidden.",
        ),
        numbered(
          "Check that all interactive controls remain usable and visible.",
        ),
        numbered(
          "Verify that navigation items, buttons, and form labels are still fully readable.",
        ),
        numbered(
          "Pay special attention to fixed-height containers, badge/chip components, and header bars — these are the most likely to break.",
        ),
      ...
      tr: [
        ...
        heading("Nasıl Test Edilir"),
        numbered(
          "Bir yer imi, tarayıcı eklentisi veya DevTools kullanarak sayfaya aşağıdaki CSS geçersiz kılmalarını uygulayın:",
        ),
        code(
        ...
        numbered(
          "Tüm sayfayı tarayarak artık kırpılan, kesilen, örtüşen veya gizlenen içeriği arayın.",
        ),
        numbered(
          "Tüm etkileşimli kontrollerin kullanılabilir ve görünür kaldığını kontrol edin.",
        ),
        numbered(
          "Gezinme öğelerinin, düğmelerin ve form etiketlerinin hâlâ tamamen okunabilir olduğunu doğrulayın.",
        ),
        numbered(
          "Sabit yükseklikli kapsayıcılara, rozet/çip bileşenlerine ve başlık çubuklarına özellikle dikkat edin — bunlar bozulma olasılığı en yüksek olanlardır.",
        ),
    ...
    resources: [
      {
        title: "Understanding SC 1.4.12: Text Spacing",
      ...
      {
        title: "WebAIM: Text Spacing Bookmarklet",
        url: "https://webaim.org/resources/contrastchecker/",
        source: "WebAIM",
        language: "en",
        _key: "r1412wai",
      ...
      {
        title: "Deque: WCAG 2.1 Text Spacing",
        url: "https://dequeuniversity.com/checklists/web/text",
        source: "Deque",
        language: "en",
        _key: "r1412deq",
      ...
      {
        title:
          "Techniques for WCAG 2 - C36: Allowing for text spacing override",
    ...
    seo: {
      en: {
        ...
        metaDescription:
          "Meet WCAG 1.4.12 Text Spacing. Ensure content survives spacing overrides for line height, letter spacing, and word spacing with CSS best practices.",
      },
      tr: {
        metaTitle: "WCAG 1.4.12 Metin Aralığı – Erişilebilirlik Rehberi",
        metaDescription:
          "WCAG 1.4.12 Metin Aralığı ölçütünü karşılayın. İçeriğin satır yüksekliği, harf ve kelime aralığı geçersiz kılmalarına dayanmasını sağlayın.",
      },
    },
  },
  ...
  // ─── 1.4.13 Content on Hover or Focus ───
  {
    ...
    resources: [
      {
        title: "Understanding SC 1.4.13: Content on Hover or Focus",
      ...
      {
        title: "Deque: Tooltips and Toggletips",
        url: "https://dequeuniversity.com/library/aria/tooltip",
        source: "Deque",
        language: "en",
        _key: "r1413deq",
      },
      {
        title: "MDN: :focus-within",
    ...
    seo: {
      en: {
        ...
        metaDescription:
          "Meet WCAG 1.4.13 Content on Hover or Focus. Make tooltips dismissible, hoverable, and persistent with HTML, CSS, and JavaScript patterns.",
      },
      tr: {
        metaTitle: "WCAG 1.4.13 Hover veya Odak İçeriği – Rehber",
        metaDescription:
          "WCAG 1.4.13 ölçütünü karşılayın. Araç ipuçlarını kapatılabilir, üzerine gelinebilir ve kalıcı yapın. HTML, CSS ve JS örnekleri.",
      },
    },
  },
];
